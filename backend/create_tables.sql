...
CREATE TABLE products(product_id SERIAL PRIMARY KEY, product_name varchar(50) NOT NULL, category varchar(20) NOT NULL, amount_in_stock integer NOT NULL, acme_rating float NOT NULL, user_rating float);
